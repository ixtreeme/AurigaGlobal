...
/*
static void GOST_ECB_Encrypt(uint32_t * N1, uint32_t * N2, const uint32_t * KeyAddress)
{
    uint32_t n1, n2; // As named in the GOST 
...
*/
int GOST_Encrypt(uint32_t * DstBuffer, const uint32_t * SrcBuffer, const uint32_t * KeyAddress, uint32_t Length, uint32_t *IVector)
{
    uint32_t i;
    uint32_t N1,N2;
...
// ************ GOST CBC decryption **************
int GOST_Decrypt(uint32_t * DstBuffer, const uint32_t * SrcBuffer, const uint32_t * KeyAddress, uint32_t Length, uint32_t *IVector)
{   
    uint32_t i;
    uint32_t N1, N2, dwTmp;
