...
CPeerBase::CPeerBase() : m_host{}, m_fd(INVALID_SOCKET), m_wPort(0), m_BytesRemain(0), m_outBuffer(nullptr),
                         m_inBuffer(nullptr)
{
}
...
int CPeerBase::Recv()
{
	...
	int64_t bytes_read = socket_read(m_fd, (char *) buffer_write_peek(m_inBuffer), bytes_to_read);
