...
bool CClientManager::InitializeMobTable()
{
	...
	memset(m_vec_mobTable.data(), 0, sizeof(TMobTable) * m_vec_mobTable.size());
	TMobTable* mob_table = m_vec_mobTable.data();
...
bool CClientManager::InitializeItemTable()
{
	...
	memset(m_vec_itemTable.data(), 0, sizeof(TItemTable) * m_vec_itemTable.size());

	TItemTable* item_table = m_vec_itemTable.data();
