...
ACMD(do_attrdialog_remove) {
	if (ecs::PlayerRuntime::IsObserverMode(AIHelpers::EcsOf(ch)) || CombatSystem::IsDead(AIHelpers::EcsOf(ch))) {
		return;
	}
...
ACMD(do_wheel_open)
{
	...
	if ((ecs::PlayerRuntime::IsObserverMode(AIHelpers::EcsOf(ch))) || (CombatSystem::IsDead(AIHelpers::EcsOf(ch))) || (CombatSystem::IsStun(AIHelpers::EcsOf(ch))))
	{
...
struct command_info cmd_info[] =
{
...
#ifdef ENABLE_NEW_CRAFT_SYSTEM_RAZOR93
	{ "stonecraft",			do_stonecraft,			0,	POS_DEAD,	GM_PLAYER	},
#endif
	...
	{ "wheel",			 do_wheel_open,  0,					 POS_DEAD, GM_PLAYER },//razor93
...
#ifdef ENABLE_GUILD_RENEWAL_BY_RAZOR93
	{ "gr_open",		do_gr_open,		0,			POS_DEAD,	GM_PLAYER	},
	{ "gr_deposit_item",	do_gr_deposit_item,	0,			POS_DEAD,	GM_PLAYER	},
	{ "gr_deposit_yang",	do_gr_deposit_yang,	0,			POS_DEAD,	GM_PLAYER	},
	{ "gr_set_tax",	do_gr_set_tax,	0,			POS_DEAD,	GM_PLAYER	},
	{ "gr_pay_tax",		do_gr_pay_tax,	0,			POS_DEAD,	GM_PLAYER	},
