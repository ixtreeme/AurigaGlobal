...
#if defined(ENABLE_WOLFMAN_CHARACTER) || defined(__VERSION_162__)
...
enum ESkillIndexes
{
	...
	SKILL_ANTI_AMSEOP,
	SKILL_ANTI_SWAERYUNG,
	SKILL_ANTI_YONGBI,
	SKILL_ANTI_GIGONGCHAM,
	SKILL_ANTI_HWAJO,
	SKILL_ANTI_MARYUNG,
	SKILL_ANTI_BYEURAK,
	SKILL_HELP_PALBANG = 236,
	SKILL_HELP_AMSEOP,
	SKILL_HELP_SWAERYUNG,
	SKILL_HELP_YONGBI,
	SKILL_HELP_GIGONGCHAM,
	SKILL_HELP_HWAJO,
	SKILL_HELP_MARYUNG,
	SKILL_HELP_BYEURAK,
#endif
...
class CSkillProto
{
	public:
		...
		uint32_t	dwType;			// 0: 전직업, 1: 무사, 2: 자객, 3: 수라, 4: 무당, 5: 모름, 6: 모름, 7: 수인족
