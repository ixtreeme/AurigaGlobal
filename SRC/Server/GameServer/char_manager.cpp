...
bool CHARACTER_MANAGER::AddToStateList(LPCHARACTER ch)
{
	...
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::bool CHARACTER_MANAGER::AddToStateList");//INGAME_DEBUG_RAZOR93
#endif
	assert(ch != NULL);
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::void CHARACTER_MANAGER::RemoveFromStateList");//INGAME_DEBUG_RAZOR93
#endif
	if (const auto it = m_set_pkChrState.find(ch); it != m_set_pkChrState.end())
	{
...
void CHARACTER_MANAGER::DelayedSave(LPCHARACTER ch) {
	...
	//	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::void CHARACTER_MANAGER::DelayedSave");//INGAME_DEBUG_RAZOR93
	//#endif
...
{
	//#ifdef ENABLE_INGAME_DEBUG_RAZOR93d
	//	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::FlushDelayedSave");//INGAME_DEBUG_RAZOR93
	//#endif
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::RegisterForMonsterLog");//INGAME_DEBUG_RAZOR93
#endif
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::UnregisterForMonsterLog");//INGAME_DEBUG_RAZOR93
#endif
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::PacketMonsterLog");//INGAME_DEBUG_RAZOR93
#endif
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::RegisterRaceNumMap");//INGAME_DEBUG_RAZOR93
#endif
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::UnregisterRaceNumMap");//INGAME_DEBUG_RAZOR93
#endif
	uint32_t dwVnum = ch->GetRaceNum();
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::GetMobItemRate");//INGAME_DEBUG_RAZOR93
#endif
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::GetMobDamageRate");//INGAME_DEBUG_RAZOR93
#endif
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::GetMobGoldAmountRate");//INGAME_DEBUG_RAZOR93
#endif
	if (!ch)
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::GetMobGoldDropRate");//INGAME_DEBUG_RAZOR93
#endif
	if (!ch) {
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::GetMobExpRate");//INGAME_DEBUG_RAZOR93
#endif
	if (!ch) {
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::GetUserDamageRate");//INGAME_DEBUG_RAZOR93
#endif
	if (!ch)
...
{
	//#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	//	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::CheckBonusEvent");//INGAME_DEBUG_RAZOR93
	//#endif
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::SendDataPlayer");//INGAME_DEBUG_RAZOR93
#endif
...
void CHARACTER_MANAGER::SetEventStatus(const uint16_t eventID, const bool eventStatus, const int endTime, const char* endTimeText)
{
	...
	if (it != m_eventText.end())
	{
		...
		for (const auto& desc : c_ref_set)
		{
			...
			ch->ChatPacketNew(CHAT_TYPE_BIG_NOTICE, eventStatus ? it->second.first : it->second.second, "");
#endif
		}
	}
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::LoadItemShopLogReal");//INGAME_DEBUG_RAZOR93
#endif
	if (!ch)
		return;
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::LoadItemShopLog");//INGAME_DEBUG_RAZOR93
#endif
	uint8_t subIndex = ITEMSHOP_LOG;
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::LoadItemShopData");//INGAME_DEBUG_RAZOR93
#endif
	TEMP_BUFFER buf;
	TPacketGCItemShop p;
	p.header = HEADER_GC_ITEMSHOP;
...
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::LoadItemShopBuyReal");//INGAME_DEBUG_RAZOR93
#endif
	if (!ch)
		return;
	...
	if (returnType == 0)
	{
		ch->ChatPacket(CHAT_TYPE_INFO, "You don't have enought dragon coin!");
		return;
	}
	else if (returnType == 1)
	{
		...
		c_pData += sizeof(int);
		ch->ChatPacket(CHAT_TYPE_INFO, "You cannot exceed the weekly purchase count.");
		return;
	}
	else if (returnType == 2)
	{
		...
		c_pData += sizeof(int);
		ch->ChatPacket(CHAT_TYPE_INFO, "You cannot exceed the monthly purchase count.");
		return;
	}
	...
	if (itemCount > 1)
		ch->ChatPacket(CHAT_TYPE_INFO, "You bought from game itemshop : count: %d Coins: %u", itemCount, itemPrice);
	else
		ch->ChatPacket(CHAT_TYPE_INFO, "You bought from game itemshop :  Coins: %u", itemPrice);
}
void CHARACTER_MANAGER::LoadItemShopBuy(LPCHARACTER ch, int itemID, int itemCount)
{
#ifdef ENABLE_INGAME_DEBUG_RAZOR93
	ch->ChatPacket(CHAT_TYPE_INFO, "char_manager.cpp::CHARACTER_MANAGER::LoadItemShopBuy");//INGAME_DEBUG_RAZOR93
#endif
	if (itemCount > 20)
		return;
					...
					if (!itEx->second.empty())
					{
						for (auto itReal = itEx->second.begin(); itReal != itEx->second.end(); ++itReal)
						{
							...
							if (std::cmp_equal(itemData.id, itemID))
							{
								...
								{
									ch->ChatPacket(CHAT_TYPE_INFO, "You don't have enough DC");
									return;
								}
...
void RefreshItemShop(LPDESC d)
{
	...
	{
		ch->ChatPacket(CHAT_TYPE_INFO, "ItemShop was update!");
