...
{
	fprintf(stdout, "sizeof(CPythonNonPlayer::TMobTable): %llu\n", sizeof(CPythonNonPlayer::TMobTable));
...
{
	fprintf(stdout, "sizeof(CItemData::TItemTable): %llu\n", sizeof(CItemData::TItemTable));
...
#ifdef ENABLE_APPLYTYPE5_RAZOR93
...
#ifdef _DEBUG
	printf("sizeof(TItemTable) %llu\n", sizeof(CItemData::TItemTable));
#ifdef ENABLE_PROTOSTRUCT_AUTODETECT
	printf("sizeof(TItemTable_r152) %llu\n", sizeof(CItemData::TItemTable_r152));
	printf("sizeof(TItemTable_r156) %llu\n", sizeof(CItemData::TItemTable_r156));
	printf("sizeof(TItemTable_r158) %llu\n", sizeof(CItemData::TItemTable_r158));
#endif
	printf("sizeof(TMobTable) %llu\n", sizeof(CPythonNonPlayer::TMobTable));
#ifdef ENABLE_PROTOSTRUCT_AUTODETECT
	printf("sizeof(TMobTable_r235) %llu\n", sizeof(CPythonNonPlayer::TMobTable_r235));
	printf("sizeof(TMobTable_r255) %llu\n", sizeof(CPythonNonPlayer::TMobTable_r255));
	printf("sizeof(TMobTable_r256) %llu\n", sizeof(CPythonNonPlayer::TMobTable_r256));
	printf("sizeof(TMobTable_r262) %llu\n", sizeof(CPythonNonPlayer::TMobTable_r262));
	printf("sizeof(TMobTable_r263) %llu\n", sizeof(CPythonNonPlayer::TMobTable_r263));
	//printf("sizeof(TMobTable_r275) %llu\n", sizeof(CPythonNonPlayer::TMobTable_r275));
#endif
#endif
