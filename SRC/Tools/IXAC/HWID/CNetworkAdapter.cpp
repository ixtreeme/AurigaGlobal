...
//		used buffer size.
////////////////////////////////////////////////////////////
uint32_t EnumNetworkAdapters(CNetworkAdapter* pAdapters, ULONG ulSzBuf, LPDWORD lpdwOutSzBuf) {
...
uint32_t CNetworkAdapter::GetAdapterIndex()				const { return m_dwIndex; }
