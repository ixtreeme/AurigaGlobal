...
typedef struct SCylinderData
{
	...
	SCylinderData() : v3Position(0.0f, 0.0f, 0.0f), fRadius(0.0f), fHeight(0.0f) {}
} TCylinderData;
...
{
	D3DXVECTOR3 v3Position = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
	D3DXVECTOR3 v3LastPosition = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
...
public:
	...
	CStaticCollisionData() : dwType(0), szName(), fDimensions() {}
};
