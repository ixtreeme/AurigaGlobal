...
bool CGraphicShadowTexture::Create(int width, int height)
{
	...
	if (FAILED(ms_lpd3dDevice->CreateDepthStencilSurface(m_width, m_height, D3DFMT_D16, D3DMULTISAMPLE_NONE, 0, false, &m_lpd3dDepthSurface, nullptr)))
		return false;
...
{
	CGraphicShadowTexture::Initialize();
}

CGraphicShadowTexture::~CGraphicShadowTexture()
{
	CGraphicShadowTexture::Destroy();
}