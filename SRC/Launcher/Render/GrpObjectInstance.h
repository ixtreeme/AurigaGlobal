...
class CGraphicObjectInstance : public CGraphicCollisionObject
{
	public:
		...
		~CGraphicObjectInstance() override;
	...
	public:
		...
		void					SetScalePositionOld(float x, float y, float z);
		...
		int						GetPortal(uint32_t dwIndex) const;
	...
	public:
		uint32_t						GetCollisionInstanceCount() const;
		CBaseCollisionInstance *	GetCollisionInstanceData(uint32_t dwIndex) const;
