...
class CMSWindow
{
	public:
		...
		void Destroy();
		bool Create(const char* c_szName, int brush=BLACK_BRUSH, uint32_t cs=0, uint32_t ws=WS_OVERLAPPEDWINDOW, HICON hIcon= nullptr, int iCursorResource=32512);
		...
		virtual void GetMousePosition(POINT* ppt);
