...
uint32_t CTextFileLoader::SGroupNode::GenNameKey(const char* c_szGroupName, UINT uGroupNameLen)
{
...
bool CTextFileLoader::Load(const char* c_szFileName)
{
	...
	memcpy(m_acBufData.get(), pvData, m_dwBufSize);
