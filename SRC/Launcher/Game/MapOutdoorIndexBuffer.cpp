...
void CMapOutdoor::ADDLvl1TL(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl1T(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp + 1;
...
void CMapOutdoor::ADDLvl1TR(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp + 1;
...
void CMapOutdoor::ADDLvl1L(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp + 1;
...
void CMapOutdoor::ADDLvl1R(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp + 1;
...
void CMapOutdoor::ADDLvl1BL(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp + 1;
...
void CMapOutdoor::ADDLvl1B(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp + 1;
...
void CMapOutdoor::ADDLvl1BR(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp + 1;
...
void CMapOutdoor::ADDLvl1M(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
	pIndices[rwCount++] = c_rwCurCount + 2;
...
void CMapOutdoor::ADDLvl2TL(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2T(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2TR(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	ADDLvl1T(pIndices, rwCount, c_rwCurCount, c_rucNumLineWarp);
...
void CMapOutdoor::ADDLvl2L(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2R(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2BL(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	ADDLvl1L(pIndices, rwCount, c_rwCurCount, c_rucNumLineWarp);
...
void CMapOutdoor::ADDLvl2B(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2 + 2;
	pIndices[rwCount++] = c_rwCurCount;
...
void CMapOutdoor::ADDLvl2BR(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2M(WORD * pIndices, WORD & rwCount, const WORD & c_rwCurCount, const uint8_t& c_rucNumLineWarp)
{
	pIndices[rwCount++] = c_rwCurCount;
	pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 4;
	pIndices[rwCount++] = c_rwCurCount + 4;
