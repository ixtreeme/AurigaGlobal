...
void CMapOutdoor::__SoftwareTransformPatch_RenderPatchSplat(SoftwareTransformPatch_SRenderState& rkTPRS, int32_t patchnum, WORD wPrimitiveCount, D3DPRIMITIVETYPE ePrimitiveType, bool isFogEnable)
{
...
void CMapOutdoor::__SoftwareTransformPatch_RenderPatchNone(SoftwareTransformPatch_SRenderState& rkTPRS, int32_t patchnum, WORD wPrimitiveCount, D3DPRIMITIVETYPE ePrimitiveType)
{
...
void CMapOutdoor::__SoftwareTransformPatch_BuildPipeline(SoftwareTransformPatch_SRenderState& rkTPRS)
{
	...
	auto ixnear = D3DXVECTOR3(0.0f, 0.0f, -rkTPRS.m_fFogNearDistance);
	auto ixfar = D3DXVECTOR3(0.0f, 0.0f, -rkTPRS.m_fFogFarDistance);

	D3DXVECTOR3 kFogNearVector;
	D3DXVec3TransformCoord(&kFogNearVector, &ixnear, &rkTPRS.m_m4Proj);

	D3DXVECTOR3 kFogFarVector;
	D3DXVec3TransformCoord(&kFogFarVector, &ixfar, &rkTPRS.m_m4Proj);
...
bool CMapOutdoor::__SoftwareTransformPatch_SetShadowStream(SoftwareTransformPatch_STLVertex* akSrcVertex)
{
	...
	ms_lpd3dDevice->SetStreamSource(0, pkVB, sizeof(SoftwareTransformPatch_SSplatVertex), 0);
	return true;
}
