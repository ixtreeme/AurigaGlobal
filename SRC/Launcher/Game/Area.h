...
class CArea
{
	public:
		...
		using TGraphicThingInstanceCRCMap = std::map<CGraphicThingInstance*, DWORD>;
	...
	public:
		...
		bool GetObjectInstancePointer(const uint32_t& dwIndex, const TObjectInstance** ppObjectInstance) const;
