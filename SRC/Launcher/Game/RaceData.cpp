...
CGraphicThing* CRaceData::NEW_RegisterMotion(CRaceMotionData* pkMotionData, WORD wMotionModeIndex, WORD wMotionIndex, const char * c_szFileName, uint8_t byPercentage)
{
...
CGraphicThing* CRaceData::RegisterMotionData(WORD wMotionMode, WORD wMotionIndex, const char * c_szFileName, uint8_t byPercentage)
{
...
void CRaceData::OLD_RegisterMotion(WORD wMotionModeIndex, WORD wMotionIndex, const char * c_szFileName, uint8_t byPercentage)
{
...
void CRaceData::__OLD_RegisterMotion(WORD wMotionMode, WORD wMotionIndex, const TMotion & rMotion)
{
	...
	if (const auto itor = pMotionModeData->MotionVectorMap.find(wMotionIndex); pMotionModeData->MotionVectorMap.end() == itor)
	{
...
bool CRaceData::SetMotionRandomWeight(WORD wMotionModeIndex, WORD wMotionIndex, WORD wMotionSubIndex, uint8_t byPercentage)
{
	TMotionModeData * pMotionModeData;
...
void CRaceData::ReserveComboAttack(WORD wMotionModeIndex, WORD wComboType, uint32_t dwComboCount)
{
...
void CRaceData::RegisterComboAttack(WORD wMotionModeIndex, WORD wComboType, uint32_t dwComboIndex, WORD wMotionIndex)
{
...
void CRaceData::Destroy()
{
	...
	for (auto itorMode = m_pMotionModeDataMap.begin(); itorMode != m_pMotionModeDataMap.end(); ++itorMode)
	{
		TMotionModeData * pMotionModeData = itorMode->second;

		for (auto itorMotion = pMotionModeData->MotionVectorMap.begin(); itorMotion != pMotionModeData->MotionVectorMap.end(); ++itorMotion)
		{
