...
bool Environment_Load(SEnvironmentData& envData, const char* envFileName)
{
	...
	if (textLoader.SetChildNode("skybox"))
	{
		...
		{
			envData.CloudGradientColor.m_FirstColor.r = std::stof(pTokenVectorCloudColor->at(0));
			envData.CloudGradientColor.m_FirstColor.g = std::stof(pTokenVectorCloudColor->at(1));
			envData.CloudGradientColor.m_FirstColor.b = std::stof(pTokenVectorCloudColor->at(2));
			envData.CloudGradientColor.m_FirstColor.a = std::stof(pTokenVectorCloudColor->at(3));

			envData.CloudGradientColor.m_SecondColor.r = std::stof(pTokenVectorCloudColor->at(4));
			envData.CloudGradientColor.m_SecondColor.g = std::stof(pTokenVectorCloudColor->at(5));
			envData.CloudGradientColor.m_SecondColor.b = std::stof(pTokenVectorCloudColor->at(6));
			envData.CloudGradientColor.m_SecondColor.a = std::stof(pTokenVectorCloudColor->at(7));
		}
		...
		if (byGradientCount == pTokenVector->size()/8)
		{
			...
			{
				envData.SkyBoxGradientColorVector[i].m_FirstColor.r = std::stof(pTokenVector->at(i*8+0));
				envData.SkyBoxGradientColorVector[i].m_FirstColor.g = std::stof(pTokenVector->at(i*8+1));
				envData.SkyBoxGradientColorVector[i].m_FirstColor.b = std::stof(pTokenVector->at(i*8+2));
				envData.SkyBoxGradientColorVector[i].m_FirstColor.a = std::stof(pTokenVector->at(i*8+3));

				envData.SkyBoxGradientColorVector[i].m_SecondColor.r = std::stof(pTokenVector->at(i*8+4));
				envData.SkyBoxGradientColorVector[i].m_SecondColor.g = std::stof(pTokenVector->at(i*8+5));
				envData.SkyBoxGradientColorVector[i].m_SecondColor.b = std::stof(pTokenVector->at(i*8+6));
				envData.SkyBoxGradientColorVector[i].m_SecondColor.a = std::stof(pTokenVector->at(i*8+7));
			}
		}
