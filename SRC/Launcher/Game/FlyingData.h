...
public:
	...
	struct TFlyingAttachData
	{
		...
		TFlyingAttachData() : iType(0), iFlyType(0), bHasTail(0), dwTailColor(0), fTailLength(0.0f), fTailSize(0.0f), bRectShape(0), fRoll(0.0f), fDistance(0.0f), fPeriod(0.0f), fAmplitude(0.0f) {}
	};
