...
class CEffectManager : public CScreen, public CSingleton<CEffectManager>
{
	...
	public:
		...
		void SetEffectOption(uint8_t Type, bool bVisible) { BLDisableEffects[Type] = bVisible; };
		bool GetEffectOption(uint8_t Type) const { return BLDisableEffects[Type]; };
