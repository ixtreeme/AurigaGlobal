...
void CLightData::GetRange(float fTime, float& rRange) const
{
...
CLightData::CLightData() : m_bLoopFlag(FALSE), m_fAttenuation0(0.0f), m_fAttenuation1(0.0f), m_fAttenuation2(0.0f), m_fDuration(1.0f), m_fMaxRange(300.0f), m_iLoopCount(0)
{
	Clear();
}
