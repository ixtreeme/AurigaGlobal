...
void CGrannyModelInstance::SetSpecularInfo(const char* c_szMtrlName, const BOOL bEnable, const float fPower) const
{
	m_kMtrlPal.SetSpecularInfo(c_szMtrlName, bEnable, fPower);
}

void CGrannyModelInstance::SetLocalTime(const float fLocalTime)
{
...
void CGrannyModelInstance::SetParentModelInstance(const CGrannyModelInstance* c_pParentModelInstance,
...
void CGrannyModelInstance::SetParentModelInstance(const CGrannyModelInstance* c_pParentModelInstance, const int iBone)
{
