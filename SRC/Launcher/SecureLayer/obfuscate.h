...
template<size_t N, wchar_t Key>
struct WStringObfuscator
{
	wchar_t data[N];

	constexpr WStringObfuscator(const wchar_t(&str)[N])
	{
...
#define OBF_W(str) (WStringObfuscator<sizeof(str) / sizeof(wchar_t), 0x55>(str).decrypt())
