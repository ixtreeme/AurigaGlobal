...
class CTerrainImpl
{
	...
	public:
		...
		uint32_t					GetShadowMapColor(float fx, float fy) const;
	...
	protected:
		...
		__forceinline uint16_t		GetHeightMapValue(short sx, short sy);
...
__forceinline uint16_t CTerrainImpl::GetHeightMapValue(short sx, short sy)
{
