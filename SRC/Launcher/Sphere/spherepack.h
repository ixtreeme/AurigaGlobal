...
public:
	...
	SpherePack * GetParent() const { return mParent; };
	...
	SpherePack * _GetNextSibling() const
	{
		return mNextSibling;
	}
	SpherePack * _GetPrevSibling() const
	{
		return mPrevSibling;
	}
	SpherePack * GetChildren()    const { return mChildren; }

	SpherePack * GetNext()     const { return mNext; }
	SpherePack * GetPrevious() const { return mPrevious; }
	...
	const Vector3d& GetPos() const { return mCenter; }
...
private:
	...
	SpherePackCallback *mCallback = nullptr;
