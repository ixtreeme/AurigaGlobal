...
PyObject * chrCreateInstance(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (PyTuple_Size(poArgs)==2)
	{
		...
		if (poHorse)
			kCreateData.m_dwMountVnum= PyLong_AsUnsignedLong(poHorse);

		PyObject* poX=PyDict_GetItemString(poDict, "x");
		if (poX)
			kCreateData.m_lPosX= _PyLong_AsInt(poX);

		PyObject* poY=PyDict_GetItemString(poDict, "y");
		if (poY)
			kCreateData.m_lPosX= _PyLong_AsInt(poY);
...
void initchr()
{
	...
	{
		{ AY_OBFUSCATE("DismountHorse"),				chrDismountHorse,					METH_VARARGS },
		{ AY_OBFUSCATE("MountHorse"),					chrMountHorse,						METH_VARARGS },

		{ AY_OBFUSCATE("Destroy"),					chrDestroy,							METH_VARARGS },
		{ AY_OBFUSCATE("Update"),						chrUpdate,							METH_VARARGS },
		{ AY_OBFUSCATE("Deform"),						chrDeform,							METH_VARARGS },
		{ AY_OBFUSCATE("Render"),						chrRender,							METH_VARARGS },
		{ AY_OBFUSCATE("RenderCollision"),			chrRenderCollision,					METH_VARARGS },

		// Functions For Python Code
		{ AY_OBFUSCATE("CreateInstance"),				chrCreateInstance,					METH_VARARGS },
		{ AY_OBFUSCATE("DeleteInstance"),				chrDeleteInstance,					METH_VARARGS },
		{ AY_OBFUSCATE("DeleteInstanceByFade"),		chrDeleteInstanceByFade,			METH_VARARGS },
		{ AY_OBFUSCATE("SelectInstance"),				chrSelectInstance,					METH_VARARGS },
	...
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_METIN_FARM", CInstanceBase::NEW_AFFECT_AUTO_METIN_FARM);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BATTLE_PASS_BOOST", CInstanceBase::NEW_AFFECT_BATTLE_PASS_BOOST);
#endif
	...
	PyModule_AddIntConstant(poModule, "AFFECT_EXP_RAZOR93", CInstanceBase::AFFECT_EXP_RAZOR93);
	PyModule_AddIntConstant(poModule, "AFFECT_ITEM_RAZOR93", CInstanceBase::AFFECT_ITEM_RAZOR93);
	PyModule_AddIntConstant(poModule, "AFFECT_METIN_RAZOR93", CInstanceBase::AFFECT_METIN_RAZOR93);
