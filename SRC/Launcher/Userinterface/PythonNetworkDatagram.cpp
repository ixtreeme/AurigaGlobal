...
void CPythonNetworkDatagram::Bind(uint32_t dwAddress, WORD wPortIndex)
{
	m_NetReceiver.Bind(dwAddress, wPortIndex);
}

void CPythonNetworkDatagram::RegisterSender(uint32_t dwID, uint32_t dwAddress, WORD wPortIndex)
{
