...
bool CPythonNetworkStream::SendSelectEmpirePacket(uint8_t dwEmpireID)
{
...
#if defined(ENABLE_PLAYER_PIN_SYSTEM)
bool CPythonNetworkStream::SendCharacterPinCodePacket(uint8_t bIndex, const char* c_szPinCode)
{
	...
	{
		Tracen("SendCharacterPinCodePacket");
		return false;
	}
