...
PyObject * backgroundRegisterEnvironmentData(PyObject * poSelf, PyObject * poArgs)
{
	...
	char * pszEnvironmentFileName = nullptr;
...
void initBackground()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ AY_OBFUSCATE("Initialize"),							backgroundInitialize,						METH_VARARGS },
		{ AY_OBFUSCATE("Update"),								backgroundUpdate,							METH_VARARGS },
		{ AY_OBFUSCATE("Render"),								backgroundRender,							METH_VARARGS },
		{ AY_OBFUSCATE("RenderPCBlocker"),					backgroundRenderPCBlocker,					METH_VARARGS },
		{ AY_OBFUSCATE("RenderCollision"),					backgroundRenderCollision,					METH_VARARGS },
		{ AY_OBFUSCATE("RenderSky"),							backgroundRenderSky,						METH_VARARGS },
		{ AY_OBFUSCATE("RenderCloud"),						backgroundRenderCloud,						METH_VARARGS },
		{ AY_OBFUSCATE("RenderWater"),						backgroundRenderWater,						METH_VARARGS },
		{ AY_OBFUSCATE("RenderEffect"),						backgroundRenderEffect,						METH_VARARGS },
		{ AY_OBFUSCATE("RenderBeforeLensFlare"),				backgroundRenderBeforeLensFlare,			METH_VARARGS },
		{ AY_OBFUSCATE("RenderAfterLensFlare"),				backgroundRenderAfterLensFlare,				METH_VARARGS },
		{ AY_OBFUSCATE("RenderCharacterShadowToTexture"),		backgroundRenderCharacterShadowToTexture,	METH_VARARGS },
		{ AY_OBFUSCATE("RenderDungeon"),						backgroundRenderDungeon,					METH_VARARGS },
		{ AY_OBFUSCATE("GetHeight"),							backgroundGetHeight,						METH_VARARGS },
