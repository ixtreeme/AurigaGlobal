...
bool PyTuple_GetThingInstance(PyObject* poArgs, int pos, CGraphicThingInstance** ppRetThingInstance)
{
	...
	*ppRetThingInstance = static_cast<CGraphicThingInstance*>(PyCapsule_GetPointer(pyHandle, nullptr));
	return *ppRetThingInstance != nullptr;
}
...
PyObject* grpThingGenerate(PyObject* poSelf, PyObject* poArgs)
{
	...
	pThingInstance->RegisterModelThing(0, dynamic_cast<CGraphicThing*>(pResource));
