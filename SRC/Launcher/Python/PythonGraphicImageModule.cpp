...
bool PyTuple_GetImageInstance(PyObject* poArgs, int pos, CGraphicImageInstance** ppRetImageInstance)
{
	...
	*ppRetImageInstance = static_cast<CGraphicImageInstance*>(PyCapsule_GetPointer(handle, nullptr));
	return (*ppRetImageInstance != nullptr);
}
...
bool PyTuple_GetExpandedImageInstance(PyObject* poArgs, int pos, CGraphicExpandedImageInstance** ppRetImageInstance)
{
	...
	*ppRetImageInstance = static_cast<CGraphicExpandedImageInstance*>(PyCapsule_GetPointer(handle, nullptr));
	return (*ppRetImageInstance != nullptr);
...
PyObject* grpImageGenerate(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (const auto capsule = PyCapsule_New(pImageInstance, nullptr, nullptr))
	{
		return capsule;
	}
...
PyObject* grpImageGenerateFromHandle(PyObject* poSelf, PyObject* poArgs)
{
	...
	CGraphicImage* pGraphicImage = nullptr;
	if (PyCapsule_CheckExact(iHandle))
	{
		pGraphicImage = static_cast<CGraphicImage*>(PyCapsule_GetPointer(iHandle, nullptr));
		if (!pGraphicImage)
			return Py_BuildException("Invalid capsule handle");
	}
	else
	{
		return Py_BadArgument();
	...
	CGraphicImageInstance* pImageInstance = CGraphicImageInstance::New();
	pImageInstance->SetImagePointer(pGraphicImage);

	PyObject* capsule = PyCapsule_New(pImageInstance, nullptr, nullptr);
	if (!capsule)
		return Py_BuildException("Could not properly register window");
