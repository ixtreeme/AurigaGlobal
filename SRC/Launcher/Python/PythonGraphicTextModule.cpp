...
bool PyTuple_GetTextInstance(PyObject* poArgs, int pos, CGraphicTextInstance** ppTextInstance)
{
	...
	*ppTextInstance = static_cast<CGraphicTextInstance*>(PyCapsule_GetPointer(handle, nullptr));
	return (*ppTextInstance != nullptr);
...
PyObject* grpTextGenerate(PyObject* poSelf, PyObject* poArgs)
{
	...
	auto capsule = PyCapsule_New(pTextInstance, nullptr, nullptr);
	if (capsule)
	{
		return capsule;
	}
