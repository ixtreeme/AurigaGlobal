...
PyObject* grpCreateTextBar(PyObject* poSelf, PyObject* poArgs)
{
	...
	auto pTextBar = new CTextBar(16, false);
	...
	auto capsule = PyCapsule_New(pTextBar, nullptr, nullptr);
	if (capsule)
	{
		return capsule;
	}
...
PyObject* grpDestroyTextBar(PyObject* poSelf, PyObject* poArgs)
{
	...
	auto pTextBar = static_cast<CTextBar*>(PyCapsule_GetPointer(iHandle, nullptr));
