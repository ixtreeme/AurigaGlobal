...
window = {
	...
	(
		...
		},
		{
			...
			"x" : SCREEN_WIDTH/2 + 128 + 66 + 5,
			"y" : 3 + Y_ADD_POSITION,

			"default_image" : "icon/item/40002.tga",
			"over_image" : "icon/item/40002.tga",
			"down_image" : "icon/item/40002.tga",
		},
		{
		...
		},
		{
			...
			# "default_image" : ROOT + "TaskBar/shop.tga",
			# "over_image" : ROOT + "TaskBar/shop_2.tga",
			# "down_image" : ROOT + "TaskBar/shop_3.tga",
		},
		{
			...
			# "default_image" : ROOT + "TaskBar/raki.tga",
			# "over_image" : ROOT + "TaskBar/raki_1.tga",
			# "down_image" : ROOT + "TaskBar/raki_2.tga",
		},
		{
			"name" : "switchbot",
			"type" : "button",
			...
			# "default_image" : ROOT + "TaskBar/opt1.tga",
			# "over_image" : ROOT + "TaskBar/opt2.tga",
			# "down_image" : ROOT + "TaskBar/opt3.tga",
		},
		{
			"name" : "battlepass",
			"type" : "button",
			...
			# "default_image" : ROOT + "TaskBar/bpas.tga",
			# "over_image" : ROOT + "TaskBar/bpas2.tga",
			# "down_image" : ROOT + "TaskBar/bpas3.tga",
		},
		{
			"name" : "ranking",
			"type" : "button",
			...
			# "default_image" : ROOT + "TaskBar/rank.tga",
			# "over_image" : ROOT + "TaskBar/rank2.tga",
			# "down_image" : ROOT + "TaskBar/rank3.tga",
		},
		{
			"name" : "btn_dailygift",
			"type" : "button",
			...
			# "default_image" : ROOT + "TaskBar/wiki.tga",
			# "over_image" : ROOT + "TaskBar/wiki_1.tga",
			# "down_image" : ROOT + "TaskBar/wiki_2.tga",
		},
		{
			"name" : "biosz",
			"type" : "button",
			...
			# "default_image" : ROOT + "TaskBar/bios.tga",
			# "over_image" : ROOT + "TaskBar/bios2.tga",
			# "down_image" : ROOT + "TaskBar/bios3.tga",
		},
		{
			"name" : "dungeon",
			"type" : "button",
			...
			# "default_image" : ROOT + "TaskBar/dung.tga",
			# "over_image" : ROOT + "TaskBar/dung2.tga",
			# "down_image" : ROOT + "TaskBar/dung3.tga",
		},
		{
