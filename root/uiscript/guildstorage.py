			...
			(
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y":3, "text":'Lonca Deposu',"horizontal_align" : "center", "text_horizontal_align":"center",},
					),
				},
