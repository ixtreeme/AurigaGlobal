...
class GuildWindow(ui.ScriptWindow):
	...
	def __MakeInfoPage(self):
		...
		try:
			...
			try:
				page.GetChild("GuildRenewalButton").SetEvent(ui.__mem_func__(self.__OnClickGuildRenewalButton))
			except:
				pass
	...
	def __OnClickSelectGuildMarkButton(self):
		#if guild.GetGuildLevel() < int(localeinfo.GUILD_MARK_TILTVA):#RAZOR93
			#self.__PopupMessage("This feature is currently not working.")#RAZOR93
	...
	def __OnClickGuildRenewalButton(self):
		# Guild Renewal window (server will answer with gr_* commands)
		net.SendChatPacket("/gr_open")
...
if __name__ == "__main__":
	...
	import dbg
	dbg.TraceError("uiguild.py: def LoadGuildBuildingList(filename): called" )
